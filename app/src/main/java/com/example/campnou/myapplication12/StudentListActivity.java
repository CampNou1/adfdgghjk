...
public class StudentListActivity extends ListActivity implements View.OnClickListener,AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener{
...
//        final int student_id = student.getId();
...
//                null, null, TableContanst.StudentColumns.MODIFY_TIME + " desc");
        ...
        adapter = new SimpleCursorAdapter(this, R.layout.activity_student_list,
                ...
                TableContanst.StudentColumns.MAJORS,
                TableContanst.StudentColumns.PHONE_NUMBER,
                TableContanst.StudentColumns.BIRTHDAY }, new int[] {
                R.id.tv_stu_id, R.id.tv_stu_name, R.id.tv_stu_age,
                R.id.tv_stu_sex, R.id.tv_stu_major, R.id.tv_stu_phone,
    ...
    private void deleteStudentInformation(final int delete_id) {
        // 利用对话框的形式删除数据
